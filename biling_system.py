...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Data Register softwere")
        bg_color = "#badc57"
        title = Label(self.root, text="Crack Billing softwere", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#badc57", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =================BillArea======================
        F5 = Frame(self.root, bd=10, relief=GROOVE, bg="#badc57")
        F5.place(x=675, y=180, width=680, height=380)

        bill_title = Label(F5, text="Bill Area", font='arial 15 bold', bd=7, relief=GROOVE, bg="#badc57")
...
#==============welcome-bill==============================
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\t\t\t\t\t\t\t\t\t Crackyyy.tech.com")
        self.txtarea.insert(END, f"\n Bill Number:{self.bill_no.get()}")
        self.txtarea.insert(END, f"\nCustomer Name:{self.c_name.get()}")
        self.txtarea.insert(END, f"\nPhone Number{self.c_phone.get()}")
        self.txtarea.insert(END, f"\n================================")
        self.txtarea.insert(END, "\t\t\t\t\t\t\t\t\t Developed by Mr.crack")
        self.txtarea.insert(END, f"\nProducts\t\tQTY\t\tPrice")
